...
WITH a AS 
(SELECT 
    c.name AS customer_name, o.customer_id AS customer_id,o.order_id AS order_id, o.order_date AS order_date, 
   rank() over(PARTITION BY c.customer_id ORDER BY o.order_date DESC) rk
FROM 
    Customers c 
INNER JOIN
    Orders o
